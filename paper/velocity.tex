\begin{deluxetable}{rcccc}
    ...
    \tablewidth{0pt}
    \tablecaption{{The evolution of the expansion velocity of \ion{Si}{2} $\lambda$6355 and \ion{Ca}{2} IRT\label{tab:vel} and the velocity of the 1\,\micron\ feature assuming a \ion{He}{1} origin in the GNIRS spectrum.}}
    \tablehead{
    \colhead{Phase} &
