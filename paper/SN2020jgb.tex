...
\begin{figure}
    ...
    \label{fig:hvp_comp}
    \caption{Line velocity comparison between the high-velocity component of \ion{Ca}{2} IRT and the infrared absorption feature at $\approx$9900 \r{A} assuming it is associated with \ion{He}{1} at 10830 \r{A}.}
\end{figure}
