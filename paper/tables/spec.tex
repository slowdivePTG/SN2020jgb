...
\enddata
\tablecomments{Phase is measured relative to the $r_\mathrm{ZTF}$-band peak in the host galaxy rest frame. The resolution $R$ is reported for the central region of the spectrum.}
\label{tab:spec}
\end{deluxetable}
